...
export default function CheckoutPage() {
  ...
  if (!journey.token || !selectedMovie || !selectedTheatre) {
    return (
      <main>
        <section className="journey-card" aria-labelledby="checkout-title">
          ...
          <p role="alert">Sign in and choose a movie and theatre before checkout.</p>
          <button type="button" onClick={() => router.push('/')}>Start again</button>
        </section>
      </main>
    );
  }
